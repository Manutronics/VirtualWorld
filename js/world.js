class World{
    ...
    #generateTrees()
    {
        ...
        while(tryCount < 100)
        {
            ...
            //check if tree too close to other
            if(keep)
            {
            ...
            //check if tree is too far of something (in the middle of nowhere)
            if(keep)
            {
    ...
    #generatebuildings()
    {
        ...
        //to have cities with trees where there are houses, it is just to remove this eps
        const eps = 0.001;
